...
public class PracticalTest02MainActivity extends AppCompatActivity {
    ...
    private class GetWeatherForecastButtonClickListener implements Button.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            String query = cityEditText.getText().toString();
            if (query == null || query.isEmpty()) {
                Toast.makeText(getApplicationContext(), "[MAIN ACTIVITY] Parameters from client (query) should be filled", Toast.LENGTH_SHORT).show();
                return;
            }
            ...
            clientThread = new ClientThread(
                    clientAddress, Integer.parseInt(clientPort), query, weatherForecastTextView
            );
            clientThread.start();
        }
